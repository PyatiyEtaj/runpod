...
python -m pip install \
  transformers accelerate safetensors pillow scipy numpy timm einops sentencepiece protobuf kornia opencv-python-headless basicsr realesrgan hf_transfer \
